...
export const AboutAnimated = () => {
  ...
  return (
    <section id="about" className="perf-section py-16 sm:py-20 bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative order-2 md:order-1">
            <div className="relative">
              ...
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                <img
                  src={optimizeImageUrl("https://images.unsplash.com/photo-1674216645383-afc4e42c227f", 1200)}
              ...
              <div className="hidden sm:block absolute -bottom-8 -left-8 w-40 h-40 bg-gradient-to-br from-green-600 via-yellow-400 to-red-600 opacity-20 rounded-lg -z-10"></div>
              <div className="hidden sm:block absolute -top-8 -right-8 w-32 h-32 border-4 border-red-600 rounded-lg -z-10"></div>
              ...
              <motion.div
                ...
                className="absolute -right-2 sm:-right-6 bottom-6 sm:bottom-10 bg-black text-white p-4 sm:p-6 rounded-lg shadow-2xl border-2 border-yellow-400"
              >
                ...
                <p className="text-xs sm:text-sm font-bold" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '0.05em' }}>
                  500+ HAPPY CUSTOMERS
                </p>
              </motion.div>
            </div>
          ...
          <motion.div variants={itemVariants} className="space-y-8 order-1 md:order-2">
            ...
            <div>
              <h2
                className="text-4xl sm:text-5xl md:text-6xl font-bold text-black mb-4 leading-none"
                style={{ fontFamily: 'Bebas Neue, sans-serif' }}
              >
                OUR STORY
              </h2>
              <p className="text-xl sm:text-2xl text-red-600 font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>
                A Taste of Senegal
              </p>
            </div>
            ...
            {/* Stats Grid */}
            <motion.div variants={itemVariants} className="grid grid-cols-3 gap-3 sm:gap-6 pt-8 border-t-2 border-black">
              ...
              <div className="text-center">
                <motion.p
                  ...
                  className="text-4xl sm:text-5xl font-bold text-yellow-600"
                  style={{ fontFamily: 'Bebas Neue, sans-serif' }}
                >
                  50+
                </motion.p>
